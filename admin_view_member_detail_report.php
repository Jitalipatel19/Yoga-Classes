...
if(isset($_POST['btnsave']))
{
	...
	//auto no code start..
	$qur1=mysqli_query($conn,"select max(event_id) from event_master");
	$eid=0;
        ...
        <div id="contact" style="padding-top: 50px;">
            <div class="container">
				...
				<div class="col-md-12 contact-col">
                    ...
                    <?php
					$res4=mysqli_query($conn,"select * from member_regis");
					if(mysqli_num_rows($res4)>0)
					{
						...
						while($r4=mysqli_fetch_array($res4))
						{
							...
							echo "<td><a href='admin_view_member_wise_event_booking_report.php?mid=$r4[0]'>VIEW EVENT BOOKING</a></td>";
							echo "<td><a href='admin_view_member_wise_course_booking_report.php?mid=$r4[0]'>VIEW COURSE BOOKING</a></td>";
