            ...
            <div class="container">
				...
				?>
                    <div class="col-lg-6 single-class">
						...
						$res5=mysqli_query($conn,"select * from booking_master where course_id='$r1[0]' and member_id='$memberid'");
						if(mysqli_num_rows($res5)>0)
						{
							$r5=mysqli_fetch_array($res5);
							?>
							<a class="btn" href="member_view_course_wise_video.php?tid=<?php echo $r5[4]; ?>&cid=<?php echo $r1[0]; ?>">VIEW VIDEO</a>
							<?php
						}else{
						?>
                                    <a class="btn" href="member_book_course.php?cid=<?php echo $r1[0]; ?>">BOOK COURSE</a>
						<?php
						}	
						?>
                                </div>
