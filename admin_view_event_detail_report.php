...
if(isset($_POST['btnsave']))
{
	...
	//auto no code start..
	$qur1=mysql_query("select max(event_id) from event_master");
	$eid=0;
...
{
	$eid1=$_REQUEST['eeid'];
	$qur2=mysql_query("select * from event_master where event_id='$eid1'");
        ...
        <div id="contact" style="padding-top: 50px;">
            <div class="container">
				...
				<div class="col-md-12 contact-col">
                    ...
                    <?php
					$res4=mysql_query("select * from event_master");
					if(mysql_num_rows($res4)>0)
					{
						...
						while($r4=mysql_fetch_array($res4))
						{
							...
							echo "<td><a href='admin_view_event_wise_booking_report.php?eid=$r4[0]'>VIEW EVENT BOOKING</a></td>";
