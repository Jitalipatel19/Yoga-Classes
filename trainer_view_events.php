...
if(isset($_REQUEST['eid']))
{
	...
	$query="insert into book_event_detail values('$beid','$eid','0','$trainer_id','$bdate')";
	if(mysqli_query($conn,$query))
	{
		echo "<script type='text/javascript'>";
		echo "alert('Event Booked Successfully');";
		echo "window.location.href='trainer_view_events.php';";
		echo "</script>";
	}	
}
                        ...
                        <div class="card card-block">
							...
							<img alt="" class="team-img" src="<?php echo $r1[7]; ?>">
                                ...
                                <div class="team-over">
									...
									<?php
									$trainer_id=$_SESSION['trainerid'];
									$res2=mysqli_query($conn,"select * from book_event_detail where event_id='$r1[0]' and trainer_id='$trainer_id'");
									...
									?>
										<a class="btn" href="trainer_view_events.php?eid=<?php echo $r1[0]; ?>">BOOK YOUR SEAT</a>
									<?php
									}
									?>
                                </div>
